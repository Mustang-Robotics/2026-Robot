...
public class AutoLaunchDrive extends Command {
    ...
    public AutoLaunchDrive(boolean rightSide, ProfiledPIDController XDrivePID,ProfiledPIDController YDrivePID, LauncherSubsystem launcher, ProfiledPIDController PID, DriveSubsystem drive, IntakeSubsystem intake) {
        m_drive = drive;
        m_launcher = launcher;
